...
public:
  void Load(physics::ModelPtr _parent, sdf::ElementPtr /*_sdf*/)
  {
    ...
    key->Translation(ignition::math::Vector3d(8.0, 9.0, 0.0));
    ...
    key->Translation(ignition::math::Vector3d(4.4, 4.4, 0.0));
    key->Rotation(ignition::math::Quaterniond(0, 0, 0));

    key = anim->CreateKeyFrame(70);
    key->Translation(ignition::math::Vector3d(4.4, 9.0, 0.0));
    key->Rotation(ignition::math::Quaterniond(0, 0, 0));
