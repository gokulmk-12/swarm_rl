...
def generate_launch_description():
    launch_file_dir = os.path.join(get_package_share_directory('sim_gazebo'), 'launch')
    ...
    set_namespace_env = SetEnvironmentVariable('ROBOT_NAMESPACE', namespace)
    ...
    ld.add_action(set_namespace_env)
