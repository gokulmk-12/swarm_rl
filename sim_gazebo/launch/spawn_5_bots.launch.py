...
def generate_launch_description():
    ...
    sdf_paths = [
        ...
        os.path.join(bringup_dir, 'models', 'turtlebot3_waffle', 'mybot5.sdf'),
    ]
    ...
    yaml_file = os.path.join('src', 'params_large.yaml')
    ...
    rviz_config_path = os.path.join(bringup_dir, 'rviz', '5bots.rviz')
